  ...
  return (
    <div className="max-w-[1105px] mx-auto rounded-[42px]">
      <div className="">
        ...
        <div className="bg-blue-100 rounded-[42px] pb-2 md:pb-9">
          <Ticket />
          <div className=" flex flex-col items-center gap-y-[22px] mt-5 mb-8">
            <div className="w-[200px] md:w-[465px] mx-auto bg-white border border-green-200 rounded-[5px] flex justify-between px-2 md:px-[18px]  font-poppins font-medium text-sm  md:text-base">
            ...
            <div className="flex flex-col md:flex-row gap-y-2 justify-center gap-x-10">
